                ...
                <div className='flex flex-col items-center md:items-start justify-center gap-4]'>
                    ...
                    <div className='mt-10 pt-5 md:pt-0 relative max-w-sm md:max-w-6xl mx-auto w-full bg-light_solid flex flex-col md:flex-row items-center justify-start md:justify-end md:pr-20 gap-3 md:gap-10 h-64 rounded-3xl'>
                        ...
                        <div className='flex flex-col items-center justify-center gap-3 md:gap-5'>
                            <h1 className='text-center md:text-right text-4xl font-bold text-secondary'>Planning for a Trip?</h1>
                            <p className='text-2xl font-medium text-secondary'>Turn Every Trip into a <span className='font-bold text-tertiary'>Golden Memories!</span></p>
                        </div>
                    </div>
                </div>
