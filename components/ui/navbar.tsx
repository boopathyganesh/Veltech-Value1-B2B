...
const AppNavbar = () => {
    ...
    return (
        <nav className='w-full h-12 flex items-center justify-center text-secondary'>
            <div className='w-full flex flex-col items-center justify-center gap-4'>
                <h2 className="ml-10 text-3xl font-bold w-full text-center">{activeItem?.title}</h2>
            </div>
            <div className='w-max flex items-center justify-center gap-5'><button className='px-3 py-3 rounded-2xl bg-primary flex items-center justify-center'>
                <BiBell className='text-2xl' />
            </button>
                <Link className='px-5 py-3 rounded-2xl bg-primary font-medium' href={'/reward-store/membership'} >Membership</Link>
                <button className='px-5 py-3 rounded-2xl bg-primary font-medium'>Upgrade</button>
                {/* Profile Section */}
                <DropdownMenu>
                    <Dialog>
