...
const MiniCardRounded: React.FC<MiniCardProps> = ({ cardTitle, icon, description })=> {
  return (
    <div data-aos='fade-down' data-aos-delay='400' className='w-32 h-48 md:h-60 md:w-36 xl:w-40 mb-4 text-black hover:text-gold-500 bg-transparent rounded-full md:p-5 flex flex-col items-center justify-start'>
