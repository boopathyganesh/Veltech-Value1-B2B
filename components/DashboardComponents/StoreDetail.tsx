...
const StoreDetail = ({ id, title, image, content, category }: StoreProps) => {
    const [isExpanded, setIsExpanded] = useState<boolean>(false)
    function handleReadMore() {
        setIsExpanded(!isExpanded);
    }
    return (
        <div className='w-full flex flex-col items-center justify-center text-secondary gap-5'>
            <div className='w-full flex items-center justify-center rounded-xl p-4 gap-5 bg-dark_bg/10'>
                ...
                <div className='flex flex-col items-start justify-center gap-2 text-secondary p-5'>
                    ...
                    <h2 className='text-lg font-medium'>Earn 24k Gold upto 23.68% per Transaction on your Orders</h2>
                    <button className='px-5 py-3 text-base bg-primary text-black rounded-2xl'>Activate Rewards</button>
                </div>
            </div>
