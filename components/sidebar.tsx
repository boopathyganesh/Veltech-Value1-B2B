...
const Sidebar = ({ menu }: SideBarProps) => {
    ...
    return (
        <div className="relative w-max hidden lg:flex">
            {/* Sidebar Toggle */}
            <button className={`flex absolute top-20 -right-3 rounded-full bg-dark_bg p-1.5 text-center smooth ${isSidebarOpen ? 'rotate-180 animate-pulse' : ''} `} onClick={toggleMenu}>
